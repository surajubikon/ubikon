                ...
                <div className="modal-overlay">
                    <div className="modal-content">
                        ...
                        <form onSubmit={handleEditSubmit} encType="multipart/form-data">
                            ...
                            <div>
                                <label>Category</label>
                                <input type="text" name="category" value={editFormData.category} onChange={handleEditChange} required />
                            </div>
                            <div>
                                <label>Tags</label>
                    ...
                    <tbody>
                        {filteredPosts.map((post) => (
                            <tr key={post._id}>
                                ...
                                <td>{post.category ? post.category.name : post.category}</td>
...
//                 seoMetaDescription: response.data.seoMetaDescription,
